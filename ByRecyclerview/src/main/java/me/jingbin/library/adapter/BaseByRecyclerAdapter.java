 ...
 */
public abstract class BaseByRecyclerAdapter<T, K extends BaseByViewHolder> extends RecyclerView.Adapter<K> {

    private ByRecyclerView mRecyclerView;
    private List<T> mData = new ArrayList<>();

    protected BaseByRecyclerAdapter() {
    }

    protected BaseByRecyclerAdapter(List<T> data) {
...
//        holder.onBaseBindView(mData.get(position), position);
    ...
    protected  abstract void onBindView(K holder, T bean, int position);
