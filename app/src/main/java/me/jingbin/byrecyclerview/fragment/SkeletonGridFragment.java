 ...
 * @author jingbin
 */
public class SkeletonGridFragment extends BaseFragment<FragmentRefreshBinding> {
    ...
    public static SkeletonGridFragment newInstance(String type) {
        SkeletonGridFragment fragment = new SkeletonGridFragment();
