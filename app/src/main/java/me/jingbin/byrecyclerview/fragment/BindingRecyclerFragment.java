 ...
 * @author jingbin
 */
public class BindingRecyclerFragment extends BaseFragment<FragmentRefreshBinding> {
    ...
    public static BindingRecyclerFragment newInstance(String type) {
        BindingRecyclerFragment fragment = new BindingRecyclerFragment();
    ...
    private void initAdapter() {
        ...
        ByDividerItemDecoration itemDecoration = new ByDividerItemDecoration(recyclerView.getContext(), androidx.recyclerview.widget.DividerItemDecoration.VERTICAL, false);
